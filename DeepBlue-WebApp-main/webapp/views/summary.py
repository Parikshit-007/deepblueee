...
def process_video(request, video_id):
    ...
    input_path_mp3 = os.path.join(settings.BASE_DIR, f'C:/Users/ASUS/Downloads/DeepBlue-WebApp-main (1)/DeepBlue-WebApp-main/media/main/videos/{video.title}.mp4')
    output_path_mp3 = os.path.join(settings.BASE_DIR, f'C:/Users/ASUS/Downloads/DeepBlue-WebApp-main (1)/DeepBlue-WebApp-main/media/main/videos/{video.title}.mp3')
    ...
    output_path_transcription = os.path.join(settings.BASE_DIR, f'C:/Users/ASUS/Downloads/DeepBlue-WebApp-main (1)/DeepBlue-WebApp-main/media/main/videos/{video.title}.txt')
 ...
 if not user_id:
    ...
    summary_obj = Summary.objects.create(video=video, summary_text=summary_text)
    summary_obj.save()
'''
    ...
    # Create the Summary object with the
